...
if os.path.isfile('src.pt') and os.path.isfile('tgt.pt'):
    SRC = torch.load('src.pt', pickle_module=dill)
    TGT = torch.load('tgt.pt', pickle_module=dill)
else:
    ...
    torch.save(SRC, 'src.pt', pickle_module=dill)
    torch.save(TGT, 'tgt.pt', pickle_module=dill)
